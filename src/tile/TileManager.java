...
public class TileManager {
	...
	public void getTileImage() {
		try {
			...
			tile[1] = new Tile();
			tile[1].image = ImageIO.read(getClass().getResource("/tiles/earth.png"));
			...
			tile[4] = new Tile();
			tile[4].image = ImageIO.read(getClass().getResource("/tiles/rockwall.png"));
	...
	public void draw(Graphics2D g2) {
		...
		while(col < gp.maxScreenCol && row < gp.maxScreenRow) {
			...
			int tileNum = mapTileNum[col][row];	//extract a number stored in map
